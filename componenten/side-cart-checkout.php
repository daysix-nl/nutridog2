           ...
           <div class="bg-white w-full lg:max-w-[448px] px-1 md:px-[unset]h-fit pt-5 pb-1">
                ...
                <div class="flex items-center justify-between w-full max-w-[354px] md:max-w-[533px] lg:max-w-[348px] lg:ml-[47px] mx-auto pl-0 md:pl-3 lg:pl-0">
                    <div class="flex items-center">
                        ...
                        <h3 class="font-jakarta text-22 leading-22 text-[#38241B] font-semibold ml-[15px]">Jouw winkelwagen</h3>
                    </div>
                ...
                <div class="w-full max-w-[354px] md:max-w-[533px] lg:max-w-[348px] lg:ml-[47px] mx-auto">
                    ...
                    <div class="flex items-start pl-0 md:pl-3 lg:pl-0">
                        ...
                        <p class="text-[#B5BBB8] text-16 leading-16 font-jakarta w-full ml-2">Voor 12:00 besteld = vandaag verzonden</p>
                    </div>
                    ...
                    <div class="h-full">
                        <div class="grid gap-2 my-[25px]">
                                                ...
                                                <div class="flex flex-col justify-between h-full"> 
                                                    <div class="">
                                                        <div class="flex justify-between">
                                                            <a href="<?php the_permalink($product->get_id());?>" class="font-jakarta text-18 leading-18 text-[#2B2828] max-w-[227px] font-semibold"><?php echo esc_html($product->get_name()); ?></a>
                                                        ...
                                                        <?php echo '<p class="product-excerpt pt-3 font-jakarta text-12 leading-12 text-[#2B2828] opacity-[0.5] line-clamp-1">' . esc_html($product->get_short_description()) . '</p>';?>
                                                    ...
                                                    <div class="flex justify-between items-end">
                                                        <div class="flex items-end">
                                                            ...
                                                            <?php 
                                                                echo '<select class="custom-quantity-input font-jakarta text-11 leading-11 p-[3px] border-[1px] border-[#2B2828] text-[#2B2828] mr-1 min-w-[41px]" data-cart-item-key="' . esc_attr($cart_item_key) . '" >';
                                                            ...
                                                            if ($product->is_type('variable')) {
                                                                ...
                                                                echo '<span class="product-variation font-jakarta text-12 leading-12 text-[#2B2828]">' . wc_get_formatted_variation($cart_item['variation']) . '</span>';
                                                            } else {
                                                            }
                                                            ?>
                                                        </div>
                                                        <?php echo '<span class="product-price font-jakarta text-16 leading-16 text-[#2B2828] font-semibold">' . wc_price($product->get_price() * $cart_item['quantity']) . '</span>';?>
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
                            ...
                            <?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
                                ...
                                <h4 class="font-jakarta text-16 leading-16 font-normal text-[#2B2828]">Kortings- of giftcard </h4>
                                <p class="font-jakarta text-16 leading-16 font-normal text-[#2B2828]">
                                    <?php wc_cart_totals_coupon_html( $coupon ); ?>
                                </p>
                            </div>
                            <?php endforeach; ?>
                            <div class="flex justify-between pl-0 md:pl-3 lg:pl-0">
                                <h4 class="font-jakarta text-16 leading-16 font-semibold text-[#2B2828]">Subtotaal</h4>
                                <p class="font-jakarta text-16 leading-16 font-semibold text-[#2B2828]">
                            ...
                            <div class="flex justify-between pl-0 md:pl-3 lg:pl-0">
                                <h4 class="font-jakarta text-16 leading-16 font-normal text-[#2B2828]">Bezorgkosten</h4>
                                <p class="font-jakarta text-16 leading-16 font-normal text-[#2B2828]">
                                    <?php
                            ...
                            <div class="flex justify-between pl-0 md:pl-3 lg:pl-0">
                                <h4 class="font-jakarta text-16 leading-16 font-semibold text-[#2B2828]">Totaal</h4>
                                <p class="font-jakarta text-16 leading-16 font-semibold text-[#2B2828]">
                                    <?php
                            ...
                            <div class="flex justify-between">
                                <p class="font-jakarta text-16 leading-16 text-[#2B2828]">Betaal veilig met</p>
