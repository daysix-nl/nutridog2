 <a href="/account" class="flex items-center space-x-[15px] w-fit mt-[0px] md:mt-[0px]">
    ...
    <p class="font-jakarta font-medium text-18 leading-48 md:text-20 md:leading-40 text-[#121212]">Account overzicht</p>
</a>
<a href="/account/bestellingen/" class="flex items-center space-x-[15px] w-fit mt-[0px] md:mt-[0px]">
    ...
    <p class="font-jakarta font-medium text-18 leading-48 md:text-20 md:leading-40 text-[#121212]">Bestellingen</p>
</a>
<a href="/account/retourneren/" class="flex items-center space-x-[15px] w-fit mt-[0px] md:mt-[0px]">
    ...
    <p class="font-jakarta font-medium text-18 leading-48 md:text-20 md:leading-40 text-[#121212]">Retourneren</p>
</a>
<a href="/account/mijn-gegevens/" class="flex items-center space-x-[15px] w-fit mt-[0px] md:mt-[0px]">
    <svg xmlns="http://www.w3.org/2000/svg" width="19.641" height="17.28" viewBox="0 0 19.641 17.28">
        <path id="love" d="M13.892,4A5.658,5.658,0,0,0,9.77,5.789,5.648,5.648,0,0,0,0,9.648c0,5.624,9.071,11.144,9.465,11.361a.611.611,0,0,0,.629,0c.376-.217,9.447-5.737,9.447-11.361A5.655,5.655,0,0,0,13.892,4ZM9.77,19.767C8.192,18.759,1.221,14.051,1.221,9.648A4.427,4.427,0,0,1,9.27,7.105a.611.611,0,0,0,1,0,4.427,4.427,0,0,1,8.051,2.543C18.319,14.048,11.349,18.756,9.77,19.767Z" transform="translate(0.05 -3.875)" fill="#121212" stroke="#121212" stroke-width="0.1"/>
    </svg>
    <p class="font-jakarta font-medium text-18 leading-48 md:text-20 md:leading-40 text-[#121212]">Mijn gegevens</p>
</a>
<a href="/account/spaarbotjes/" class="flex items-center space-x-[15px] w-fit mt-[0px] md:mt-[0px]">
    <svg xmlns="http://www.w3.org/2000/svg" width="19.641" height="17.28" viewBox="0 0 19.641 17.28">
        <path id="love" d="M13.892,4A5.658,5.658,0,0,0,9.77,5.789,5.648,5.648,0,0,0,0,9.648c0,5.624,9.071,11.144,9.465,11.361a.611.611,0,0,0,.629,0c.376-.217,9.447-5.737,9.447-11.361A5.655,5.655,0,0,0,13.892,4ZM9.77,19.767C8.192,18.759,1.221,14.051,1.221,9.648A4.427,4.427,0,0,1,9.27,7.105a.611.611,0,0,0,1,0,4.427,4.427,0,0,1,8.051,2.543C18.319,14.048,11.349,18.756,9.77,19.767Z" transform="translate(0.05 -3.875)" fill="#121212" stroke="#121212" stroke-width="0.1"/>
    </svg>
    <p class="font-jakarta font-medium text-18 leading-48 md:text-20 md:leading-40 text-[#121212]">Spaarbotjes</p>
</a>
<a href="<?php echo esc_url( wp_logout_url() ); ?>" class="flex items-center space-x-[15px] w-fit mt-[0px] md:mt-[0px]">
    <svg xmlns="http://www.w3.org/2000/svg" width="19.641" height="17.28" viewBox="0 0 19.641 17.28">
        <path id="love" d="M13.892,4A5.658,5.658,0,0,0,9.77,5.789,5.648,5.648,0,0,0,0,9.648c0,5.624,9.071,11.144,9.465,11.361a.611.611,0,0,0,.629,0c.376-.217,9.447-5.737,9.447-11.361A5.655,5.655,0,0,0,13.892,4ZM9.77,19.767C8.192,18.759,1.221,14.051,1.221,9.648A4.427,4.427,0,0,1,9.27,7.105a.611.611,0,0,0,1,0,4.427,4.427,0,0,1,8.051,2.543C18.319,14.048,11.349,18.756,9.77,19.767Z" transform="translate(0.05 -3.875)" fill="#121212" stroke="#121212" stroke-width="0.1"/>
    </svg>
    <p class="font-jakarta font-medium text-18 leading-48 md:text-20 md:leading-40 text-[#121212]">Uitloggen</p>
</a>