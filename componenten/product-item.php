...
<div class="product-item h-fit relative">
        ...
        <div class="aspect-square w-full bg-[#F2F4F5] flex justify-center items-center rounded-[10px] overflow-hidden relative">
            <img src="<?php echo get_the_post_thumbnail_url($product->get_id()); ?>" alt="" class="h-[65%] w-auto max-h-[calc(100%-80px)] md:max-h-[calc(100%-100px)] px-2 mix-blend-multiply">
