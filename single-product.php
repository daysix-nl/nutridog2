...
<main class="share-close">
    ...
    <div class="w-full mt-8 lg:px-5 md:flex justify-between">
        <div class="w-full md:w-[199px] lg:w-[340px] xl:w-[378px] relative">
            ...
            <h3 class="text-15 leading-16 md:text-16 md:leading-28 tracking-[0.1em] font-jakarta italic uppercase md:mt-[0px] lg:mt-[15px]">Maak je set compleet!</h3>
            <h2 class="text-20 leading-24 md:max-w-[510px] lg:max-w-[unset] lg:text-36 lg:leading-42 tracking-[0.07em] font-grotesk text-[#FF91C8] uppercase mt-[10px] lg:mt-[15px]">Combinatie <span class="text-[#FF6248]"><br>advies</span></h2>
        </div>
