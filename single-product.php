                    ...
                    if ($product->is_type('variable')) {
                        ...
                        <div class="pt-3">
                            <?php
                                ...
                                ?>
                                <div class="mt-[20px]">
                                    <button id="share-button-mobile" type="button" class="justify-center flex lg:hidden font-jakarta font-semibold text-14 leading-24 text-[#000000] opacity-20 underline text-left w-full">Deel dit product</button>
                                </div>
                        </div>
                    ...
                    <?php
                        ...
                        <div class="w-full grid gap-[15px] mt-4">
                            ...
                            <div class="flex items-start">
                                ...
                                <p class="text-[#525252] text-14 leading-14 font-jakarta w-full ml-2 block">Bij dit product ontvang je <?php if ($product->is_type('variable')) { echo "minimaal"; }?> <?php echo $resultaat ?> <a href="/spaarbotjes" class="underline">spaarbotjes</a></p>
                            </div>
                            <div class="flex items-start">
                                <svg class="mt-[2px] w-[13.697px]" xmlns="http://www.w3.org/2000/svg" width="13.697" height="9.781" viewBox="0 0 13.697 9.781">
                                    <path id="Path_202" data-name="Path 202" d="M8331.749,406.758l-7.468,7.367-3.4-3.4" transform="translate(-8319.466 -405.343)" fill="none" stroke="#8cc63f" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
