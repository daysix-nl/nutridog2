...
<div class="input-quantity flex justify-between pb-2">
	<p class="text-16 leading-32 font-jakarta font-normal text-[#2B2828]">Selecteer het aantal</p>
	<div class="quantity flex">
		...
		<input
			...
			class="border-t-[1px] border-b-[1px] border-[#2B2828] h-3 w-3 font-jakarta text-16 flex justify-center items-center text-center rounded-none"
