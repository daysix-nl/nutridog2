...
?>
<div class="input-quantity flex justify-between pb-2 mr-[15px]">
	<div class="quantity flex items-center justify-center border-[1px] border-[#707070] h-[45px] rounded-[30px] w-[100px]">
		<?php
		/**
		...
		<label class="screen-reader-text" for="<?php echo esc_attr( $input_id ); ?>"><?php echo esc_attr( $label ); ?></label>
			...
			<div class="quantity-decrease h-3 w-3 bg-transparent flex justify-center items-center">
			...
			<input
				...
				class="h-3 w-3 font-jakarta text-16 flex justify-center items-center text-center rounded-none"
				...
				<?php endif; ?>
			/>
			<div class="quantity-increase h-3 w-3 bg-transparent flex justify-center items-center">
